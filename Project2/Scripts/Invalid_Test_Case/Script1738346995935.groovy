...
WebUI.setText(findTestObject('Object Repository/Page_QA Practice  Learn with RV/input_Email_emailAddress'), 'demo@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_QA Practice  Learn with RV/input_Password_password'), 'PblvLzUlPsM=')
...
WebUI.click(findTestObject('Object Repository/Page_QA Practice  Learn with RV/div_Bad credentials Please try again Make s_5a4980'))
